...
using Burgerama.Services.Venues.Endpoint.Handlers;
using MassTransit;
using Topshelf;
    ...
    public sealed class Program
    {
        static void Main(string[] args)
        {
            var host = HostFactory.New(cfg =>
            {
                ...
                cfg.SetServiceName("Burgerama.Services.Venues.Endpoint");
                cfg.SetDisplayName("Burgerama.Services.Venues.Endpoint");
                cfg.SetDescription("Burgerama.Services.Venues.Endpoint");
        ...
        private static IContainer GetAutofacContainer()
        {
            ...
            // Event handlers
            builder.RegisterType<RatingUpdatedHandler>().AsSelf();
            builder.RegisterType<VoteAddedHandler>().AsSelf();
